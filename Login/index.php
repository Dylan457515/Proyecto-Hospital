...
<body>
		...
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
					...
					<div class="text-right p-t-8 p-b-31">
						<a href="#" onclick="AbrirModalRestableser()">
	...
	<div class="modal fade" id="modal_reestableser_contra" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header" style="text-align: left;">
                    <h4 class="modal-title"><b>Reestableser contrase&ntilde;a</b></h4>
                ...
                <div class="modal-footer">
                    <button class="btn btn-primary" onclick="Restableser_Contra()"><i class="fa fa-check"><b>&nbsp;Enviar</b></i></button>
