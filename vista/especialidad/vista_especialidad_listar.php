        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-lg-12">
                    ...
                    <input type="text" class="form-control" id="txt_especialidad" placeholder="Ingrese insumo medico" maxlength="50" onkeypress="return soloLetras(event)"><br>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-lg-12">
                    ...
                    <label for="">Nombre</label>
                    <input type="text" id="txt_especialidad_actual_editar" placeholder="Ingrese insumo medico" maxlength="50" onkeypress="return soloLetras(event)" hidden>
                    <input type="text" class="form-control" id="txt_especialidad_nuevo_editar" placeholder="Ingrese insumo medico" maxlength="50" onkeypress="return soloLetras(event)"><br>
                </div>
