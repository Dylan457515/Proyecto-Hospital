        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="col-lg-12">
                    ...
                    <input type="text" class="form-control" id="txt_Alias" placeholder="Ingrese Alias de medicamento" maxlength="50" onkeypress="return soloLetras(event)"><br>
                </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-primary" onclick="Registro_Medicamentos()"><i class="fa fa-check"><b>&nbsp;Registrar</b></i></button>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="col-lg-12">
                    <label for="">Alias</label>
                    <input type="text" class="form-control" id="txt_Alias_editar" placeholder="Ingrese Alias de medicamento" maxlength="50" onkeypress="return soloLetras(event)"><br>
                </div>
...
<form autocomplete="false" onsubmit="return false">
    <div class="col-md-12">
        <div class="box box-warning box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">ESTADISTICA DE MEDICAMENTOS</h3>
                <!-- /.box-tools -->
            </div class="col-md-12">
            <!-- /.box-header -->
            <div class="box-body">
                <div class="col-lg-12" style="padding-top:40px; text-align:center;">
                  <div class="card">
                    <div class="card-body">
                      <div class="row">
                        <div class="col-lg-6">
                          <canvas id="StadisticasMedicamentos" width="400" height="400"></canvas>
                        </div>
                      </div>
                    </div>
                  </div>
