    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header" style="text-align:center;">
                ...
                <h4 class="modal-title" ><b>Registro de Procedimiento Medico</b></h4>
            </div>
...
<div class="modal fade" id="modal_editar" role="dialog">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header" style="text-align:center;">
                <button type="button" class="close" data-dismiss="modal" >&times;</button>
                <h4 class="modal-title" ><b>Editar Procedimiento Medico</b></h4>
            </div>
            <div class="modal-body">
                <div class="col-lg-12">
                    <input type="text" id="txt_idprocedimiento" hidden>
                    <label for="">Nombre</label>
                    <input type="text" id="txt_procedimiento_actual_editar" placeholder="Ingrese procedimiento medico" hidden><br>
