<?php
    ...
    $consulta = $MM->Modificar_Medico($idmedico,$nombre,$apepat,$apemat,$direccion,$movil,$sexo,$fenac,$nrodocumentoactual,$nrodocumentonuevo,$colegiaturaactual,$colegiaturanuevo,$especialidad,$idusuario,$email);
    echo $consulta;
